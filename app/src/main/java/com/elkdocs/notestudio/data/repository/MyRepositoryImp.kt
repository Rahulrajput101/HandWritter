package com.elkdocs.notestudio.data.repository

import android.graphics.Bitmap
import com.elkdocs.notestudio.data.data_source.MyDao
...
class MyRepositoryImp(
    ...
    override suspend fun updateFolderIcon(folderId: Long, folderIcon: Bitmap) {
        myDao.updateFolderIcon(folderId,folderIcon)
    }
